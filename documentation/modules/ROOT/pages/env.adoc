...
Edit the _Java Quarkus_ application you created using the Dev Spaces IDE (alternatively you can use *vi* or something similar if you want):

image::open-file.png[Che - Workspace]
...
[NOTE]
====
Remember to click yes on allowing the redirect to the port.

image::open-port.png[Allow redirect]
...
You can do this either in the editor in Dev Spaces or directly in the file in the terminal using vi or something similar.
